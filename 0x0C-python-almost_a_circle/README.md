...
This Project is a week project given in preparation for the AirBnB project.
unitest were written to test files, classes were used to reference codes in models
e.g rectangles and squares. The knowledge of OOP is fully utilised.

The classes used involve utilizing the following Python tools:
* Import
* Exceptions
* Private attributes
* Getter/setter
